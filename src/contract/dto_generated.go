...
type ObjectRef struct {
	...
	Extensions    RegisteredExtensions `json:"extensions"`
}
...
type InputEnvelope struct {
	...
	DataClass          string               `json:"data_class"`
	Extensions         RegisteredExtensions `json:"extensions"`
	AnswerToQuestionID *string              `json:"answer_to_question_id,omitempty"`
}
...
type QuestionProposals []map[string]any

type SecurityClassification struct {
	DataClass string `json:"data_class"`
}

type RegisteredExtensions = map[string]any
